"""
generate_from_plantilla_v2.py
Rellena la plantilla oficial SI886-PLANTILLA-TALLER (1).docx con los datos completos
del Taller 05 para la Municipalidad Provincial de Tacna, actualiza el TOC y exporta a PDF.
"""
...
def run():
    ...
    # 2. ELIMINAR SOLO LA PÁGINA "CÓMO SE USA ESTA PLANTILLA" (P50 a P57)
    # Buscamos el párrafo con estilo Heading 1 que dice "Cómo se usa esta plantilla"
    ...
    print(f"Eliminados {len(paragraphs_to_remove)} párrafos de instrucciones de la plantilla.")
    ...
    try:
        ...
        # Actualizar todos los campos y la tabla de contenidos
        w_doc.Fields.Update()
        try:
